...
describe("Factory/Question Contract", () => {
  it('Random market simulation', async()=>{ // Changes from "allows validators to stake and validate."
    ...
    for(let i = 1; i<=80; i++){
      ...
      randomEth = randomNumber(1, 100);
      console.log('STAKING PHASE :: option: '+randomOption + ' Eth: '+randomEth);
    ...
    for(let i = 81; i<=100; i++){
      randomOption = randomNumber(0, 1);
      randomEth = randomNumber(1, 70);
      console.log('VALIDATION PHASE :: option: '+randomOption + ' Eth: '+randomEth);
